...
public class AkkaException extends RuntimeException {
    ...
    public AkkaException(String title, String description, Throwable cause) {
    ...
    public AkkaException(String title, String description) {
     ...
     */
    @SuppressWarnings({"unused", "ManualArrayToCollectionCopy", "ToArrayCallWithZeroLengthArrayArgument"})
    public abstract static class ExceptionSource extends AkkaException {
    ...
    public abstract static class ExceptionAttachment extends AkkaException {
